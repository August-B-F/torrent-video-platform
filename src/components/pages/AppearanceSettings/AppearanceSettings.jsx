...
const AppearanceSettings = () => {
  ...
  const handleFolderIconChange = (folderId, newIconValue) => {
    ...
    } else if (finalIconValue.length > 0 && finalIconValue.length <= 2 && /\p{Emoji}/u.test(finalIconValue)) { 
      iconType = FOLDER_ICON_OPTIONS.EMOJI;
    } else if (Object.values(FOLDER_ICON_OPTIONS).includes(finalIconValue)) { 
      iconType = finalIconValue;
      finalIconValue = null; 
    } else if (finalIconValue === '') { 
        iconType = FOLDER_ICON_OPTIONS.DEFAULT;
        finalIconValue = null;
    }
    else if (finalIconValue && !iconType) { 
        iconType = FOLDER_ICON_OPTIONS.EMOJI;
    }
                   ...
                   <select 
                      ...
                      onChange={(e) => {
                          ...
                          if (val === 'custom') {
                              ...
                              handleFolderIconChange(folder.id, val); 
                          }
                      }}
